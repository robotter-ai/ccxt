...
import { Balances, Currencies, Dictionary, IndexType, Int, Market, Num, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Ticker, Tickers, Trade, TradingFeeInterface, Transaction } from './base/types.js';
/**
 * @class cube
 * @augments Exchange
 */
export default class cube extends Exchange {
    ...
    parseBalance(response: any, allOrders?: any): Balances;
