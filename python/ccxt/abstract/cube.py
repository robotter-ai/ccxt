...
class ImplicitAPI:
    ...
    rest_iridium_private_get_users_orders = restIridiumPrivateGetUsersOrders = Entry('/users/orders', ['rest', 'iridium', 'private'], 'GET', {'cost': 1})
    rest_iridium_private_get_users_fills = restIridiumPrivateGetUsersFills = Entry('/users/fills', ['rest', 'iridium', 'private'], 'GET', {'cost': 1})
