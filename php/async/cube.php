...
class cube extends Exchange {
    ...
    public function fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $request = array();
            // $response = Async\await($this->restMendelevPublicGetParsedBookMarketIdRecentTrades($this->extend($request, $params)));
            //
            // {
            //     "result":{
            //         "trades":array(
            ...
            // }
            //
            $response = Async\await($this->restMendelevPublicGetParsedBookMarketSymbolRecentTrades (array_merge($request, $params)));
            //
            // {
            //     "result":{
            //         "ticker_id":"BTCUSDC",
