...
| params | <code>object</code> | Yes | extra parameters specific to the exchange api endpoint EXCHANGE SPECIFIC PARAMETERS |
| type | <code>int</code> | Yes | position type，1: long, 2: short |
| page_num | <code>int</code> | Yes | current page number, default is 1 |


```javascript
mexc.fetchPositionsHistory ([symbols, since, limit, params, type, page_num])
```
...
- https://mxcdevelop.github.io/apidocs/spot_v3_en/#margin-account-orders
