...
```javascript
onetrading.fetchTrades (symbol[, since, limit, params])
```
...
```javascript
onetrading.createDepositAddress (code[, params])
```
...
```javascript
onetrading.fetchDepositAddress (code[, params])
```
...
```javascript
onetrading.fetchDeposits (code[, since, limit, params])
```
...
```javascript
onetrading.fetchWithdrawals (code[, since, limit, params])
```
...
```javascript
onetrading.withdraw (code, amount, address, tag[, params])
```
...
```javascript
onetrading.fetchOrder (symbol[, params])
```
